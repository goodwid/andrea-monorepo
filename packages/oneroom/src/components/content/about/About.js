...
const About = () => {
  ...
  return (
    <div className={styles.content}>
      ...
      <p>
        “I follow you. One of the wonderfully brilliant things about participating in individualized art lessons is
        that curiosity&nbsp;
        <img src={andrea} className="right" align="right"/>
        is the guide! What are you interested in? A period in Art History, a watercolor painting technique, or a
        conceptual theory about your creative process. Maybe you’ve never understood color theory, or you want to
        learn to talk about art. With individualized art lessons, the journey is collaborative. Together we, the
        student and teacher, decide what comes next on the artistic path. It’s like taking a mentor along with you
        on your path to becoming an accomplished artist.”
      ...
      <p>
        Andrea is the granddaughter of two teachers, and is proud to continue their legacy. Her grandmother, Audrey Madden Rosselle graduated from a&nbsp;
        <a href="https://www.potsdam.edu/about/college-history" target="blank" rel="noopener noreferrer">
          teacher’s college
        </a>
        &nbsp;in&nbsp;<img src={collage} className="left" align="left"/>
        upstate New York in the 1930’s. One of Audrey’s teaching assignments, when her sons were young children, was in a&nbsp;
        <a href="http://www.townofbleecker.com/" target="blank" rel="noopener noreferrer">
          one room schoolhouse
        </a>
        &nbsp;in&nbsp;
        <a href="https://dailygazette.com/article/2013/05/18/bleecker-was-once-booming-community" target="blank" rel="noopener noreferrer">
          Bleecker Stage.
        </a>
        &nbsp;Andrea, whose father was Audrey’s middle child, grew up with stories and influences
        of this rural schoolhouse. Many of the philosophies inherent in the&nbsp;
        <a href="https://teaching.cornell.edu/teaching-resources/engaging-students/collaborative-learning" target="blank" rel="noopener noreferrer">
          collaborative,
        </a>&nbsp;
        <a href="https://education.stateuniversity.com/pages/2336/Progressive-Education.html" target="blank" rel="noopener noreferrer">
          progressivist,
        </a>&nbsp;
        <a href="https://www.seenmagazine.us/Articles/Article-Detail/articleid/5596/the-one-room-schoolhouse-vs-competency-based-education" target="blank" rel="noopener noreferrer">
          competency-based
        </a>
      ...
      <p>
        ...
        &nbsp;
        Learning about the lives, practices, inspirations, and movements of artists and cultures, who have
      ...
      <p>
        ...
        processes within the greater field of Visual Art. Coming to understand the deeper semiology of the&nbsp;
        <a href="https://www.brown.edu/Departments/Joukowsky_Institute/courses/artinantiquity/7158.html" target="blank" rel="noopener noreferrer">
          Visual Culture
        </a>
        &nbsp;we live in, Andrea became an avid explorer of how to make meaning with a&nbsp;
        <a href="https://www.toledomuseum.org/education/visual-literacy/what-visual-language" target="blank" rel="noopener noreferrer">
          visual language.
        </a>
        &nbsp;Exploring how we visually
      ...
      <p>
        ...
        &nbsp;A ceramic sculptor, painter, and mixed
        media artist, she has explored tools, techniques, and materials throughout her career. Knowing the how and why of a&nbsp;
        <a href="https://www.tate.org.uk/art/student-resource/exam-help/materials" target="blank" rel="noopener noreferrer">
          material&apos;s properties
        </a>
        &nbsp;is an important skill set for both an artist and teacher. Andrea has also explored a
